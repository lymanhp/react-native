...
const BODCOLO=['blue', 'red', 'yellow', 'green', 'pink'];
  ...
  render(){
    ...
    for(var i=0; i < PAGES; i++){
      var pageStyle = {
        ...
        alignItems: 'center',
        borderWidth: 2,
        borderColor: BODCOLO[i % BODCOLO.length],
        padding: 20,
      };
      if(i < PAGES - 1){
        //前面几个viewpage
...
class BaiYouProject extends Component {
  render() {
...
AppRegistry.registerComponent('BaiYou', () => BaiYouProject);
